...
export const CUSTOMER_CREATED_SUCCESS: string = 'Your profile has been created successfully';
export const CUSTOMER_CREATED_FAILED: string = 'Internal server triggered an error';
